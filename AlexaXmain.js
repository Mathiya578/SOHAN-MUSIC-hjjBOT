...
if (isBanChat) return reply(mess.banChat)
     ...
     console.log(anui)
    XeonBotInc.sendMessage(from, {image:{url:anui}, caption:"Making BY AlexaX Devil Sudda"}, {quoted:m})
}
   break
  case 'whitebear':{
  	if (isBan) return reply(mess.ban)	 			
...
console.log(anu)
XeonBotInc.sendMessage(from,{image:{url:anu}, caption:"Making BY AlexaX Devil Sudda"},{quoted:m})
}
break
case 'retro':{
	if (isBan) return reply(mess.ban)	 			
